...
**NOTE:** This method does not delete or erase your previous embeddings(more on state fallbacks in [VersionControlWrapper](https://docs.incribo.com/essentials/version_control)).
